...
${OBJECTDIR}/scr/app_check.o: scr/app_check.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/scr" 
	@${RM} ${OBJECTDIR}/scr/app_check.o.d 
	@${RM} ${OBJECTDIR}/scr/app_check.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  scr/app_check.c  -o ${OBJECTDIR}/scr/app_check.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/scr/app_check.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -DXPRJ_PIC24FJ128GB204_CodeModel_Large=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mlarge-code -O0 -I"." -I"scr" -I"framework/fileio" -I"framework/usb" -I"mcc_generated_files" -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/scr/app_check.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
