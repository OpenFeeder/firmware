...
void APP_SerialDebugTasks( void )
{
    ...
    // d or D: display data logger buffer
    // e or E: measuring RDY/CLK period of EM4095
    ...
    // q or Q: display battery level buffer
    ...
    // w or W: toggle power command "CMD_ACC_PIR"
    ...
    if ( UART1_TRANSFER_STATUS_RX_DATA_PRESENT & UART1_TransferStatusGet( ) )
    {
        ...
        switch ( data_from_uart1 )
        {
            ...
            case '?':
                ...
                printf( " b or B: set blue color value of attractive LEDs\n" );
                ...
                printf( " g or G: set green color value of attractive LEDs\n" );
                printf( " h or H: toggle door remain open parameter\n" );
                printf( " i or I: enable IR \n" );
                printf( " j or J: disable IR \n" );
                printf( " k or K: display IR2 (Food level)\n" );
                printf( " l or L: call i2cScanner( ) --> 0x02, 0x06 and 0xE0\n" );
                printf( " m or M: Toggle PCA9622 device ON or OFF\n" );
                printf( " n or N: Toggle LED D16 color Green or Red\n" );
                printf( " o or O: open reward door\n" );
                printf( " p or P: change servomotor position\n" );
                printf( " q or Q: display battery level buffer\n" );
                printf( " r or R: (set red color value of attractive LEDs) --> RFID SHD EM4095 ENABLE\n" );
