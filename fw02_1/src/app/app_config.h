...
typedef enum
{
    ...
    INI_PB_REWARD_ENABLE, // 29
        
    INI_PB_TIMEOUTS_SLEEP, // 30
    INI_PB_TIMEOUTS_PIR, // 31
    INI_PB_TIMEOUTS_REWARD, // 32

    INI_PB_PIT_TAG_DENIED, // 33
    INI_PB_PIT_TAG_ACCEPTED, // 34

    INI_PB_PUNISHMENT_DELAY, // 35

    INI_PB_DOOR_HABITUATION // 36
