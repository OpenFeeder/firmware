...
typedef enum
{
    ...
    INI_PB_DOOR_TON_MIN, // 19
    INI_PB_DOOR_TON_MAX, // 20
    INI_PB_DOOR_SPEED, // 21

    INI_PB_DOOR_OPEN_DELAY, // 22
    INI_PB_DOOR_CLOSE_DELAY, // 23

    INI_PB_DOOR_REMAIN_OPEN, // 24

    INI_PB_DOOR_REWARD_PROBABILITY, // 25

    INI_PB_DOOR_OPEN_HOUR, // 26
    INI_PB_DOOR_OPEN_MINUTE, // 27

    INI_PB_DOOR_CLOSE_HOUR, // 28
    INI_PB_DOOR_CLOSE_MINUTE, // 29

    INI_PB_REWARD_ENABLE, // 30
        
    INI_PB_TIMEOUTS_SLEEP, // 31
    INI_PB_TIMEOUTS_PIR, // 32
    INI_PB_TIMEOUTS_REWARD, // 33

    INI_PB_PIT_TAG_DENIED, // 34
    INI_PB_PIT_TAG_ACCEPTED, // 35

    INI_PB_PUNISHMENT_DELAY, // 36

    INI_PB_DOOR_HABITUATION // 37
