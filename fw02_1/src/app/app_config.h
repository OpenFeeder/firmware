...
typedef enum
{
    ...
    INI_PB_DOOR_TON_MIN, // 20
    INI_PB_DOOR_TON_MAX, // 21
    INI_PB_DOOR_SPEED, // 22

    INI_PB_DOOR_OPEN_DELAY, // 23
    INI_PB_DOOR_CLOSE_DELAY, // 24

    INI_PB_DOOR_REMAIN_OPEN, // 25

    INI_PB_DOOR_REWARD_PROBABILITY, // 26

    INI_PB_DOOR_OPEN_HOUR, // 27
    INI_PB_DOOR_OPEN_MINUTE, // 28

    INI_PB_DOOR_CLOSE_HOUR, // 29
    INI_PB_DOOR_CLOSE_MINUTE, // 30

    INI_PB_REWARD_ENABLE, // 31
        
    INI_PB_TIMEOUTS_SLEEP, // 32
    INI_PB_TIMEOUTS_PIR, // 33
    INI_PB_TIMEOUTS_REWARD, // 34

    INI_PB_PIT_TAG_DENIED, // 35
    INI_PB_PIT_TAG_ACCEPTED, // 36

    INI_PB_PUNISHMENT_DELAY, // 37

    INI_PB_DOOR_HABITUATION // 38
