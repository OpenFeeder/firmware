...
ifeq "$(wildcard nbproject/Makefile-local-OF_fw_2_1_brd_3_0_ver_arnauld.mk)" "nbproject/Makefile-local-OF_fw_2_1_brd_3_0_ver_arnauld.mk"
include nbproject/Makefile-local-OF_fw_2_1_brd_3_0_ver_arnauld.mk
endif
endif
...
# Macros
CND_CONF=OF_fw_2_1_brd_3_0_ver_arnauld
...
ConfName=OF_fw_2_1_brd_3_0_ver_arnauld
ImagePath="dist\OF_fw_2_1_brd_3_0_ver_arnauld\${IMAGE_TYPE}\fw02_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ImageDir="dist\OF_fw_2_1_brd_3_0_ver_arnauld\${IMAGE_TYPE}"
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-OF_fw_2_1_brd_3_0_ver_arnauld.mk dist/${CND_CONF}/${IMAGE_TYPE}/fw02_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
	@echo "--------------------------------------"
	@echo "User defined post-build step: [copy /Y /B ${ProjectDir}\${ImagePath} /B ${ProjectDir}\..\hex\fw02_1.hex && C:\Users\Asus-Home\Anaconda3\python ${ProjectDir}\..\python\OF_fw_zip_hex.py ${ProjectDir}]"
	@copy /Y /B ${ProjectDir}\${ImagePath} /B ${ProjectDir}\..\hex\fw02_1.hex && C:\Users\Asus-Home\Anaconda3\python ${ProjectDir}\..\python\OF_fw_zip_hex.py ${ProjectDir}
	@echo "--------------------------------------"
...
${OBJECTDIR}/_ext/659850791/app.o: ../src/app/app.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/659850791/app.o.d 
	@${RM} ${OBJECTDIR}/_ext/659850791/app.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../src/app/app.c  -o ${OBJECTDIR}/_ext/659850791/app.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/659850791/app.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_OF_fw_2_1_brd_3_0_ver_arnauld=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mlarge-code -O0 -I"../src" -I"../src/app" -I"../src/driver" -I"../src/framework/fileio" -I"../src/framework/minini" -I"../src/framework/usb" -I"mcc_generated_files" -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/_ext/659850791/app.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
.pre:
	@echo "--------------------------------------"
	@echo "User defined pre-build step: [C:\Users\Asus-Home\Anaconda3\python ${ProjectDir}\..\python\OF_fw_version.py ${ProjectDir}]"
	@C:\Users\Asus-Home\Anaconda3\python ${ProjectDir}\..\python\OF_fw_version.py ${ProjectDir}
	@echo "--------------------------------------"
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/OF_fw_2_1_brd_3_0_ver_arnauld
	${RM} -r dist/OF_fw_2_1_brd_3_0_ver_arnauld
